...
@Component({
  selector: 'app-add-politique',
  templateUrl: './add-politique.component.html',
  styleUrls: ['./add-politique.component.css']
})
export class AddPolitiqueComponent {
  sujet: string = '';
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<AddPolitiqueComponent>,
